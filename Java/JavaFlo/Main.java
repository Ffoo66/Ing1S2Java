...
public class Main {
	public static void main (String args[]) {
		...
		cm1.ajoutProduitAff("Viande", 2);
		cm1.ajoutProduitAff("Intelligence", 5);
		cm1.ajoutProduitAff("Intelligence", 10);
		cm1.ajoutProduitAff("Ordinateur", 50);
		...
		cm2.ajoutProduitAff("Viande", 2);
		cm2.ajoutProduitAff("Viande", 3);
		cm2.ajoutProduitAff("Argent", 5);
		cm2.ajoutProduitAff("Projet", 50);

		System.out.println("\n\n\n-------------------------------------------------------------------------------\n\n\n");
		System.out.println(cm1.getProduitsAff());
		System.out.println(cm2.getProduitsAff());
		...
		*/
		...
		System.out.println("\n\n\n-------------------------------------------------------------------------------\n\n\n");
		System.out.println(ct.getNotifPleine(bacArray.get(0).getIdBac()));
